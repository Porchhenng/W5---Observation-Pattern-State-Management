...
import 'package:week5/EXERCISE-1/utils/date_time_util.dart';
...
class _RideScreenState extends State<RideScreen> {
  ...
  void findRides() {
    foundRides = RidesService.instance.getRides(ridePref: ridePref, filter: null );
