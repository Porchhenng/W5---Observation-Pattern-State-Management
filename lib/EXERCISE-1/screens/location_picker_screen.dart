...
import 'package:week5/EXERCISE-1/service/locations_service.dart';
import 'package:week5/EXERCISE-1/theme/theme.dart';
...
class _LocationPickerScreenState extends State<LocationPickerScreen> {
  ...
  void onChange(String updateValue) {
    setState(() {
      locationResults =
          LocationsService.instance.repository
              .getLocation()
      ...
      child: Row(
        children: [
          Padding(
            ...
            child: IconButton(
              onPressed: onBackTap,
              icon: Icon(Icons.arrow_back_rounded, color: BlaColors.iconNormal),
            ),
          ),
          Expanded(
            child: TextField(
  ...
  Widget baseTile(
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            if (leftIcon != null) Icon(leftIcon, color: BlaColors.neutral),
            Expanded(
              child: Column(
            ...
            Icon(Icons.arrow_forward_rounded, color: BlaColors.neutral),
          ],
        ),
      ),
    );
